      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          <div className="flex items-start">
            ...
            <div className="ml-6">
              <h2 className="text-xl font-bold text-gray-900 mb-2">Welcome to Your Employer Dashboard!</h2>
              <p className="text-gray-600 mb-4">
                This is your command center for managing job postings, reviewing applicants, and building your team.
              </p>
