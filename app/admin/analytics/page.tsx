      ...
      <div className="bg-gradient-to-r from-emerald-600 to-blue-600 rounded-lg p-6 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-emerald-100 mt-2">Comprehensive insights and performance metrics across all platform activities</p>
          </div>
          ...
          <div className="p-6">
            <div className="h-64 flex items-end justify-between space-x-2">
              <div className="flex flex-col items-center">
                <div className="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t" style={{height: '120px'}}></div>
                <span className="text-xs text-gray-500 mt-2">Jun</span>
                <span className="text-xs text-gray-400">₹6.2L</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t" style={{height: '140px'}}></div>
                <span className="text-xs text-gray-500 mt-2">Jul</span>
                <span className="text-xs text-gray-400">₹6.8L</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t" style={{height: '160px'}}></div>
                <span className="text-xs text-gray-500 mt-2">Aug</span>
                <span className="text-xs text-gray-400">₹7.1L</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t" style={{height: '180px'}}></div>
                <span className="text-xs text-gray-500 mt-2">Sep</span>
                <span className="text-xs text-gray-400">₹7.5L</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t" style={{height: '200px'}}></div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-semibold text-blue-600">5,847</span>
            </div>
            <div className="flex items-center justify-between">
