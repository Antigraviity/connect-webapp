                ...
                <tr key={city.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-lg bg-gradient-to-r from-primary-500 to-primary-600 flex items-center justify-center text-white font-semibold text-sm">
                  ...
                  <td className="px-6 py-4">
                    <div>
                      ...
                      <div className="text-sm text-primary-600">{city.activeUsers.toLocaleString()} active</div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="space-y-1">
                      <div className="text-xs text-primary-600">{city.serviceProviders} providers</div>
                      <div className="text-xs text-green-600">{city.jobSeekers.toLocaleString()} job seekers</div>
                      <div className="text-xs text-primary-600">{city.employers} employers</div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div>
                  ...
                  <td className="px-6 py-4">
                    <div>
                      ...
                      <div className="text-sm text-primary-600">Completion: {city.serviceCompletionRate}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="space-y-1">
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      ...
                      <span className="text-xs text-primary-600 font-medium">Share: {state.marketShare}</span>
                    </div>
                  </div>
                </div>
              ))}
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-primary-600">{region.dominantServices}</div>
                      </div>
                      <div className="text-right">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {penetrationMetrics.map((metric, index) => (
              <div key={index} className="text-center p-4 bg-gradient-to-br from-primary-50 to-primary-50 rounded-lg">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-primary-50 rounded-lg">
              <div className="text-xl font-bold text-primary-600">Future Opportunity</div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-primary-600">Across all markets</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-primary-600">32.8%</div>
              <div className="text-sm text-gray-600">Expansion Potential</div>
              <div className="text-xs text-primary-600">Untapped markets</div>
            </div>
          </div>
        </div>
      </div>
