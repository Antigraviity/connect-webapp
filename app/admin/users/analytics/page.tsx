    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-6 text-white">
          ...
          <p className="text-indigo-100 mt-2">Comprehensive analytics and insights for all platform users</p>
        </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {userCategories.map((category, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-blue-600">+{category.newThisMonth}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm">
                        ...
                        {user.hired && <div className="text-purple-600">{user.hired} hired</div>}
                        {user.rating && (
                          <div className="flex items-center">
                ...
                {monthlyUserData.slice(-6).map((month, index) => (
                  <div key={index} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-sm text-gray-900">
                        <span className="text-green-600 font-medium">+{month.newUsers}</span> new
                      </div>
