...
export default function ServiceSupportPage() {
    ...
    const fetchTickets = async () => {
        try {
            setLoading(true);
            // Ideally pass type=SERVICE filter if backend supports it
            const response = await fetch("/api/tickets?type=SERVICE");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Service Support Tickets</h1>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200">
                    <h2 className="text-lg font-semibold text-gray-900">My Service Tickets</h2>
                </div>
