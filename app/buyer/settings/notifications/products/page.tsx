    ...
    useEffect(() => {
        const fetchPreferences = async () => {
            try {
                ...
                if (data.success && data.preferences?.productNotifications) {
                    setNotifications(data.preferences.productNotifications);
                }
            } catch (error) {
        ...
        <div className="p-6 space-y-6 max-w-5xl mx-auto">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 font-primary">Product Notification Preferences</h1>
                        <p className="text-sm text-gray-500 mt-1">Control how you stay connected for orders and shopping alerts.</p>
                    </div>
                </div>
                <button
                    onClick={handleSave}
                ...
                <div>
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="space-y-6">
                            <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Shopping Zone Alerts</h3>
